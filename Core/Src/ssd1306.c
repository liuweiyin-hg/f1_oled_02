...
void ssd1306_RollingHorizontal(void) {
	ssd1306_WriteCommand(0x2e);//关滚动
	ssd1306_WriteCommand(0x26);//29向右，2a向左
	ssd1306_WriteCommand(0x00);//A:空字节
	ssd1306_WriteCommand(0x00);//B:水平起始页
	ssd1306_WriteCommand(0x04);//C:水平滚动速度
	ssd1306_WriteCommand(0x07);//D:水平结束页
	ssd1306_WriteCommand(0x00);// Dummy Byte 00
	ssd1306_WriteCommand(0xff);// Dummy Byte ff
...
void ssd1306_RollingHV(void) {
	...
	ssd1306_WriteCommand(0x00);        //虚拟字节
	ssd1306_WriteCommand(0x00);        //起始页 0
	ssd1306_WriteCommand(0x07);        //滚动时间间隔
	ssd1306_WriteCommand(0x07);        //终止页 1
